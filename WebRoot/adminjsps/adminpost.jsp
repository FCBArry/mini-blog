...
<title>miniblog-adminpost</title>
		...
		<div class="header row">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="javascript:void(0);">帖子管理</a>
					</li>
					<li><a href="<c:url value='/adminuser_findAll.action'/>">用户管理</a>
					</li>
					<li><a href="<c:url value='/admincomment_findAll.action'/>">评论管理</a>
					</li>
						...
						<tbody>
							<c:forEach items="${pb.beanList }" var="post">
								<tr>
									<td>${post.ptitle }</td>
									<td><a
										href="<c:url value='/adminpost_delete.action?pid=${post.pid }'/>"><span
